  ...
  const EditProfile = async (event: SyntheticEvent) => {
    ...
    try {
      result = await axios({
        ...
        url: "https://notesxdapi.herokuapp.com/users/update",
      });
      console.log(result);
  ...
  const uploadHandler = async (event: any) => {
    ...
    try {
      result = await axios.put(
        "https://notesxdapi.herokuapp.com/users/update",
        formData,
        {
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <MenuItem value="male" style={{ backgroundColor: "#32A05F" }}>
                    Male
                  </MenuItem>
                  <MenuItem
                    value="female"
