...
const Sidebar: FC<{ toggleModal: Function }> = (props) => {
  ...
  const { noteLists, handleSetNoteLists, active, setActive } =
    useContext(Context);
  ...
  async function setNotes(id: string) {
    ...
    try {
      result = await axios({
        ...
        url: `https://notesxdapi.herokuapp.com/notes/getAllNote/${id}`,
      });
  ...
  async function getTrash() {
    ...
    try {
      result = await axios({
        ...
        // withCredentials : true,
        url: `https://notesxdapi.herokuapp.com/notes/gettrash`,
      });
  ...
  async function getCollaboratedNotes() {
    ...
    try {
      result = await axios({
        ...
        // withCredentials : true,
        url: `https://notesxdapi.herokuapp.com/notes/collaborators/notes`,
      });
      console.log(result.data);
      console.log("jhds");
  ...
  useEffect(() => {
    const getFolders = async () => {
      ...
      let logs = await axios({
        ...
        url: "https://notesxdapi.herokuapp.com/notes/getfolder",
      });
      ...
      <div className={classes.sidebarWrapper}>
              ...
              <div key={index}>
                ...
                >
                  <PlayArrowIcon
                    ...
                    style={
                      active === el._id
                        ? { cursor: "pointer", color: "#020202" }
                        : { cursor: "pointer", color: "#4a4949" }
                    }
                  />
                  <div
                    ...
                    style={
                      active === el._id
                        ? { fontFamily: "poppins", color: "#020202" }
                        : { fontFamily: "poppins", color: "#4a4949" }
                    }
                  >
        ...
        <div className={classes.addNew} style={{ cursor: "pointer" }}>
          ...
          <h3
            ...
            style={{ fontFamily: "poppins", color: "#4a4949" }}
