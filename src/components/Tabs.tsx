...
const Tabs = () => {
  const { noteLists, handleSetNoteLists, handleOnEdit, active } =
    useContext(Context);
  ...
  const createNote = async () => {
    ...
    try {
      result = await axios({
        ...
        url: `https://notesxdapi.herokuapp.com/notes/createNote/${active}`,
      });
  ...
  const fetchNotes = async () => {
    ...
    try {
      result = await axios({
        ...
        // withCredentials : true,
        url: `https://notesxdapi.herokuapp.com/notes/desc?sort=${select}`,
      });
      ...
      <div className={classes.tabsWrapper}>
        <div className="notes-header">
          <div className="noteupdate">
            ...
            >
              <option value="descending" style={{ backgroundColor: "white" }}>
                Last Updated
              </option>
          ...
          <div className="button">
            {active ? (
              <button className="notebtn" onClick={() => createNote()}>
        ...
        <div
          style={{ overflow: "scroll", height: "97vh", overflowX: "scroll" }}
        >
          {noteLists!.map((val) => {
            return (
              <EachNote
